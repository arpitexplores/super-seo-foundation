...
5. Rename the extracted folder from `super-seo-foundation-main` to `super-seo-foundation`.
6. Copy the renamed `super-seo-foundation` folder into your agent's skills directory.
...
This repository is the `super-seo-foundation` skill. Keep the full `super-seo-foundation` folder together when installing it.
