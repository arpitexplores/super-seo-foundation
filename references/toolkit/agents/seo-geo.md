...
Allow for AI search visibility: GPTBot, OAI-SearchBot, provider-specific AI crawler, PerplexityBot
Optional block (training only): CCBot, provider-specific-ai-crawler, cohere-ai
