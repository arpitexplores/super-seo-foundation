...
AI assistant SEO follows Anthropic's official AI coding assistant skill specification with a modular, multi-skill architecture.
...
4. Installs skill to `tool-specific skills path/seo-<name>/`
5. Installs agent to `tool-specific config pathsagents/seo-<name>.md`
6. Merges MCP config into `tool-specific config pathssettings.json` (non-destructive)
