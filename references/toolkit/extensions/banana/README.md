# Banana Image Generation Extension for AI assistant SEO
...
> This extension wraps image generation tooling
> for SEO-specific use cases. Install the standalone skill for general-purpose image generation.

- **AI assistant SEO** installed (`tool-specific skills path/seo/`)
- **Node.js 18+** with npx
...
The assistant acts as a **Creative Director**. It never passes raw text to the API.
Instead, it analyzes your intent, selects the optimal domain mode, and constructs
an optimised prompt using a proven 6-component Reasoning Brief system:
...
6. **Lighting** (10%):Direction, quality, colour temperature

## Post-Generation SEO Checklist

After every generation, AI assistant provides:
...
This removes the skill and agent. If you also use image generation tooling,
