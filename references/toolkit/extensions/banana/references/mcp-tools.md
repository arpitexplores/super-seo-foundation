...
**Example usage in AI coding assistant:**
```
User: "Generate a sunset over mountains in watercolor style"
→ AI assistant calls gemini_generate_image with prompt
...
→ AI assistant calls gemini_edit_image with path and instruction
```
