...
When a preset is active, AI assistant uses its values as defaults for the Reasoning Brief:
...
# Create interactively (AI assistant fills in details from conversation)
