#!/usr/bin/env python3
"""
Setup script for Claude Banana MCP server in AI coding assistant.

Configures @ycse/nanobanana-mcp in AI coding assistant's settings.json
...
def load_settings() -> dict:
    """Load AI coding assistant settings.json."""
...
def save_settings(settings: dict) -> None:
    """Save AI coding assistant settings.json."""
...
def remove_mcp() -> None:
    ...
    if MCP_NAME in servers:
        ...
        print(f"Removed '{MCP_NAME}' from AI coding assistant settings.")
    else:
        print(f"'{MCP_NAME}' not found in settings.")


def setup_mcp(api_key: str) -> None:
    """Configure MCP server in AI coding assistant settings."""
    ...
    print(f"\nRestart AI coding assistant for changes to take effect.")
