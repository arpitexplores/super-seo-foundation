# DataForSEO Extension for AI assistant SEO
...
- [AI assistant SEO](https://github.com/AgriciDaniel/seo-toolkit) installed
- Node.js 20+
...
3. Configure the MCP server in `tool-specific config pathssettings.json`
...
- **AI optimisation**: ~0.01 per request
...
## Integration with AI assistant SEO

When installed, other AI assistant SEO skills automatically detect DataForSEO availability and use live data:
...
1. Check credentials: `cat tool-specific config pathssettings.json | grep DATAFORSEO`
...
- [AI assistant SEO](https://github.com/AgriciDaniel/seo-toolkit)
