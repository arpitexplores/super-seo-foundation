...
Step-by-step guide to getting DataForSEO API credentials for the AI assistant SEO extension.
...
If the installer's auto-configuration fails, add this to `tool-specific config pathssettings.json`:
  ...
  "mcpServers": {
    "dataforseo": {
      ...
      "env": {
        ...
        "FIELD_CONFIG_PATH": "/home/youruser/.agent/skills/seo/dataforseo-field-config.json"
      }
    }
  }
}
...
After installing, start AI coding assistant and run:
